...
## 예제
ggu-lang으로 쓰여진 코드의 예시들은 [examples.md](examples.md)를 참고해주세요.

## 실행
인터프리터는 다음과 같이 ggu-lang 코드를 실행합니다.
